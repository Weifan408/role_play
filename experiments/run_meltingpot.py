...
from callbacks.meltingpot_callbacks import MeltingPotCallbacks
...
from envs.meltingpot.wrappers.meta_rl_wrappers import meta_rl_env, ObsRewriteEnv
...
def env_creator(env_config):
    ...
    if env_config["env_zoo"] == "meltingpot":
...
if __name__ == "__main__":
    ...
    with open(pathlib.Path.cwd() / "configs/meltingpot.yaml", "r") as file:
