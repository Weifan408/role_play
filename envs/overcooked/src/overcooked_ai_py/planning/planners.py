...
import numpy as np
import pickle, time
from envs.overcooked.src.overcooked_ai_py.utils import manhattan_distance
from envs.overcooked.src.overcooked_ai_py.planning.search import (
    Graph,
    NotConnectedError,
)
...
from envs.overcooked.src.overcooked_ai_py.data.planners import (
...
class MotionPlanner(object):
    ...
    def from_pickle_or_compute(
        mdp, counter_goals, custom_filename=None, force_compute=False, info=False
    ):
...
#
#         if SAFE_RUN:
#             from envs.overcooked_new.src.overcooked_ai_py.mdp.overcooked_env import OvercookedEnv
