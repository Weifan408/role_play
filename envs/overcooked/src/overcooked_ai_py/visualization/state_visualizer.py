...
from envs.overcooked.src.overcooked_ai_py.static import GRAPHICS_DIR, FONTS_DIR
...
from envs.overcooked.src.overcooked_ai_py.visualization.visualization_utils import (
    show_image_in_ipython,
    show_ipython_images_slider,
)
from envs.overcooked.src.overcooked_ai_py.visualization.pygame_utils import (
